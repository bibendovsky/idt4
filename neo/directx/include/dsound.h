...
#if NTDDI_VERSION < 0x05010000 /* Windows 2000 */
#define DIRECTSOUND_VERSION 0x0700  /* Version 7.0 */
#elif NTDDI_VERSION < 0x05010200 || NTDDI_VERSION == 0x05020000 /* Windows XP and SP1, or Windows Server 2003 */
...
/*
 * IDirectSound8, IDirectSoundBuffer8 and IDirectSoundCaptureBuffer8 are the only DirectSound 7.0 interfaces with
 * changed functionality in version 8.0. The other level 8 interfaces as equivalent to their level 7 counterparts:
 */
...
extern HRESULT WINAPI DirectSoundCaptureCreate8(
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer8,IDirectSoundCaptureBuffer)
{
	...
	STDMETHOD(GetObjectInPath)(
		...
		REFGUID rguidInterface,
		LPVOID* ppObject) PURE;
	STDMETHOD(GetFXStatus)(DWORD dwEffectsCount, LPDWORD pdwFXStatus) PURE;
};
...
typedef struct _DSFXI3DL2Reverb
{
	...
	FLOAT   flDecayTime;            /* [     0.1,    20.0] default:     1.49 s  */
